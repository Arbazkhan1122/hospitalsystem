...
function Ipbilling() {
  ...
  const grandTotal =
    totalRoomCharges + totalDoctorFees + totalMedications + totalOtherServices;
  ...
  const handleShareBill = () => {
    if (navigator.share) {
      if (pdfBlob) {
        ...
        const file = new File([pdfBlob], "billing_details.pdf", {
    ...
    <div className="ipd_billing-container">
      <div className="ipd_billing-input-group">
        <div className="ipd_billing-input-container">
          ...
          />
          <button onClick={handleIpdButtonClick}>Search</button>
        </div>
      </div>
      ...
      {isIpdTableVisible && (
        <div className="ipd_billing-section print-content">
          <div className="ipd-patientdetails">
            ...
            <span>
              <FaMale size={14} color="#000" title="Age" />
              &nbsp;Age/Sex:&nbsp;{patientDetails.ageSex}&nbsp;&nbsp;&nbsp;
            </span>
            <span>
              <FaCalendarCheck size={14} color={"#000"} />
              &nbsp;Visit Type:&nbsp;{patientDetails.visitType}
            </span>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span>
              <FaAddressBook size={14} color={"#000"} />
              &nbsp;Address:&nbsp;{patientDetails.address}
            </span>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span>
              <FaPhone size={14} color={"#000"} />
              &nbsp;Contact No:&nbsp;{patientDetails.contactNo}
            </span>
            &nbsp;&nbsp;&nbsp;&nbsp;
          </div>
          ...
          <div className="ipd-opd-printsection">
            <button className="ipdbill-printbtn" onClick={handlePrintTable}>
              Print
            </button>
            <button className="ipdbill-printbtn" onClick={handleGeneratePDF}>
              Generate Bill
            </button>
            <button className="ipdbill-printbtn" onClick={handleShareBill}>
              Share Bill
            </button>
          </div>
        </div>
