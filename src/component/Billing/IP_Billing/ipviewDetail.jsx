...
const [patientData, setPatientData] = useState(null);
  ...
  return (
    ...
    <div className="billing-page">
     ...
     <div class="navbar">
        ...
        <button className="ipviewdetail-new intern-btn new-item" onClick={() => openbtnModal('newInternModal')}>New Item</button>
        {modals.newInternModal && (
         ...
         <div className="modal-content-ipviewdetail-new-intern-btn">
           ...
           <div className="form-groupipviewdetail-newintern-btn">
             <label className='labelipviewdetail-newintern-btn'>Membership *:</label>
           ...
           <div className="form-groupipviewdetail-newintern-btn">
             <label className='labelipviewdetail-newintern-btn'>Price Category:</label>
             <select className="selectlabelipviewdetail-newintern-btn">
               <option>Normal</option>
             </select>
           </div>
           ...
           <table className="tableipviewdetail-newintern-btn">
             <thead>
               <tr>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Department</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Prescriber</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Performer</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>ItemName</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Qty</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Price</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>VAT</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>Tax Amt</th>
                 <th className='tablehead-ipviewdetail-newintern-btn'>SubTotal</th>
               </tr>
             </thead>
             <tbody>
               <tr>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="text" placeholder="Enter Department" /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="text" placeholder="Enter Name" /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="text" placeholder="Enter Name" /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="text" placeholder="ENTER ITEM NAME" /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="number" defaultValue={1} /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="number" defaultValue={0} /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="number" defaultValue={13} /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="number" defaultValue={0} /></td>
                 <td className='tabledata-ipviewdetail-newintern-btn'><input className='ipviewdetail-newintern-btn-input' type="number" defaultValue={0} /></td>
               </tr>
             </tbody>
           ...
           <button onClick={() => closebtnModal('newInternModal')} className="ipviewdetail-new-intern-btn-new-item-close-button">Cancle</button>
             <button className="print-slip-ipviewdetail-new-intern-btn">Print Slip</button>
             <button className="request-ipviewdetail-new-intern-btn">Request</button>
           </div>
        ...
        <button class="estimation-bill" onClick={()=> openbtnModal('estimateBillModal')}>Estimation Bill</button>
  ...
  <div className="detail-column">
    ...
    <div className="detail-item">
      <b>Disch. Date:</b> <input type="date" value="2024-08-21" /> <input type="time" value="16:06" />
    </div>
    <div className="detail-item">
      <b>Credit Amount:</b> 0
    </div>
        ...
        <div className="modal fade-in">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button onClick={closeModal} className="cancel-button">Cancel Item</button>
            </div>
          </div>
        </div>
      )}
