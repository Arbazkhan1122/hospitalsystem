...
import "./NursingWardTransfer.css"; // Import the corresponding CSS file
import axios from "axios"; // Make sure to install axios
import { API_BASE_URL } from "../api/api";

const NursingWardTransfer = ({ patient, setShowModal }) => {
  console.log(patient);
    ...
    <div className="WardTransfer-container">
      ...
      <form className="WardTransfer-form-section" onSubmit={handleSubmit}>
        ...
        <div className="WardTransfer-right-column">
          ...
          <p>
            Current Ward/Bed: {patient?.wardName} / {patient?.bedNumber}
          </p>
          <hr />
          <h4>Ward History</h4>
...
export default NursingWardTransfer;
