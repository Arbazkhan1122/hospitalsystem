...
import AddActiveProblem from '../DashBoards/AddActiveProblems'; // Import the AddActiveProblem component

const ActiveProblems = ({ onClose }) => {
  const [activeTab, setActiveTab] = useState('ActiveProblems');
  const [showAddActiveProblem, setShowAddActiveProblem] = useState(false); // State for AddActiveProblem
        ...
        return (
          <section className="ive-active-problems">
            <div className="ive-header">
              ...
              <button className="ive-add-btn" onClick={() => setShowAddActiveProblem(true)}>Add</button>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="#" className="ive-edit-link" onClick={() => setShowAddActiveProblem(true)}>Edit</a></td>
                </tr>
                <tr>
  ...
  return (
    <div className="ive-container">
      ...
      {renderContent()}
      {showAddActiveProblem && <AddActiveProblem />} {/* Render AddActiveProblem if state is true */}
    </div>
  );
};
