    ...
    <div className="new-chas-container">
      ...
      <form onSubmit={handleSubmit}>
        <div className="new-chas-form-group">
          ...
          />
          <button type="button" className="new-chas-info-btn">?</button>
        </div>
        
        <div className="new-chas-form-row">
          <div className="new-chas-form-group">
          ...
          <tbody>
            {items.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                  <button type="button" className="new-chas-remove-btn" onClick={() => removeRow(index)}>×</button>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <button type="button" className="new-chas-add-row-btn" onClick={addNewRow}>+ Add New Row</button>
        <span className="new-chas-items-count">Items Count: {items.length}</span>
        
        <div className="new-chas-totals">
          <div className="new-chas-total-row">
            <span>SubTotal:</span>
        ...
        <div className="new-chas-form-actions">
          <button type="submit" className="new-chas-save-btn">Save As Draft</button>
          <button type="button" className="new-chas-discard-btn" onClick={discardChanges}>Discard Changes</button>
        </div>
      </form>
    </div>
  );
